<div class="max-w-6xl mx-auto px-5 my-5 mt-20">
    {{-- Logo --}}
    <div class="">
        <div class="">
            <img src="/img/logo/csc.png" alt="cendana-solution-center" loading="lazy" class="w-full min-h-[100px] max-h-[150px] md:min-h-[200px] object-contain select-none pointer-events-none">
        </div>
        ...
        <p class="text-slate-700 text-justify mb-10">
            ...
            <br><br>
            Dengan fondasi yang kuat, jejaring nasional, dan semangat kolaboratif, PT. Cendana Solution Center, melalui PUSTAKA PEMDA, PUSDIKLATNAS, dan PSPI, siap menjadi mitra strategis bagi pemerintah desa, kecamatan, hingga kabupaten di seluruh penjuru negeri.
        </p>
    </div>
</div>