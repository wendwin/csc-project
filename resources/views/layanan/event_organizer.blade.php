<x-layout :navbar="null" :css="'/layanan/event_organizer.css'">
    <div class="description-page">
        <h5>Layanan</h5>
        <h4>Event Organizer</h4>
    </div>
    <div class="intro-event-section p-3 p-lg-5 mt-5 my-lg-5 d-flex flex-column flex-lg-row align-items-center">
    ...
    <div class="gallery-event-section d-flex flex-wrap justify-content-center align-items-center gap-5">
        ...
        <img src="/img/layanan/event-organizer/event-gallery-4.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-5.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-6.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-7.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-8.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-9.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-10.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-11.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-12.png" alt="">
        <img src="/img/layanan/event-organizer/event-gallery-13.png" alt="">
