...
{{-- silahkan costumise tampilannya --}}
        ...
        <div
            ...
            <div class="intro-text-section p-2 p-lg-5 order-0 order-lg-1">
                ...
                <p>Cendana Solution Center adalah mitra terpercaya yang menghadirkan solusi komprehensif di bidang event
                    ...
                    efisiensi, kualitas, dan dampak positif terhadap lingkungan dalam setiap proyek yang kami jalankan.
    ...
    <div
        class="sejarah-section d-flex flex-column flex-lg-row justify-content-between align-items-end align-items-lg-center">
        ...
        <div class="sejarah-text-section px-4 px-lg-5">
            ...
            <div class="sejarah-text-container ">
                ...
                <p>Sejak didirikan pada tahun 2000, Cendana Solution Center (CSC) telah berkomitmen untuk menjadi
                    ...
                    memberikan solusi kreatif dan efektif, menjadikan setiap momen yang kami ciptakan sebagai pengalaman
    ...
    <div class="visi-misi-section d-flex flex-column flex-lg-row justify-content-between align-items-center">
        ...
        <div class="visi-misi-text-section pt-5 pb-3 py-lg-0 px-4 px-lg-5">
            ...
            <ul>
                ...
                <li>Misi : </li>
                <ol>
                    <li>Memberikan pembekalan pengetahuan mengenai peraturanperundang-undangan yang berlaku serta
                        pengetahuan pentinglainnya agar mudah dipahami dan diterapkan untuk mencapai tujuan.</li>
                    <li>Menjelaskan tugas dan tanggung jawab individu sesuai keahlianmereka, baik dalam pemerintahan,
                        sektor swasta, maupunmasyarakat umum, untuk meningkatkan kinerja dan kompetensidi bidang
                        masing-masing.</li>
                    <li>Menjalin kerja sama dengan instansi pemerintah,swasta, dan lembaga pendidikan untuk menciptakan
                        hubungan yang saling mendukung dan transparan, dengan tujuan utama menyebarkan pengetahuan
                        tersebut kepada masyarakat umum.</li>
                </ol>
            </ul>
        </div>
    </div>
